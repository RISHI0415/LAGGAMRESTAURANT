...
const HeroSection = () => (
  <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
    <img src={heroImg} alt="Bhagath Singh Youth Association members" className="absolute inset-0 w-full h-full object-cover" />
    ...
    >
      ...
      <p className="text-lg md:text-xl text-white/80 mb-10 max-w-xl mx-auto">
        Serving the community with pride, unity, and devotion — every year, every celebration.
      </p>
